...
Formålet med prosjektet er å kode og trene en fungerende tekst-prediktor i vanilla python + numpy, i tilsvarende nevralt nettverk-arkitektur som brukt i LLMs. Prosjektet er basert på teori og grunn-mal for kode gitt i TMA4320 i 2024 (https://wiki.math.ntnu.no/_media/tma4320/2024v/prosjektbeskrivelse_01.03.pdf).
