...
Modellen bruker embedding av tekst i en vektorrepresentasjon, som kjøres gjennom L lag som kombinerer attention med feed-forward activation. Activation-funksjonen som tas i bruk er ReLu. Loss måles i crossentropy.
